# [algebra](/libs/algebra/)::[nn](/libs/algebra/nn/)::AutoEncoderNetwork

## Attributes

### encoder_layer_idx:&nbsp;[int](/libs/std/core/type.int.md)

### encoder_layer_name:&nbsp;[String](/libs/std/core/type.String.md)

### encoder_layer_var:&nbsp;[String](/libs/std/core/type.String.md)
...
### fn decode(engine:&nbsp;[ComputeEngine](/libs/algebra/compute/type.ComputeEngine.md), input:&nbsp;[Tensor](/libs/std/core/type.Tensor.md)):&nbsp;[Tensor](/libs/std/core/type.Tensor.md)
### fn encode(engine:&nbsp;[ComputeEngine](/libs/algebra/compute/type.ComputeEngine.md), input:&nbsp;[Tensor](/libs/std/core/type.Tensor.md)):&nbsp;[Tensor](/libs/std/core/type.Tensor.md)
...
### fn new(inputs:&nbsp;[int](/libs/std/core/type.int.md), tensor_type:&nbsp;[TensorType](/libs/std/core/enum.TensorType.md), inputs_gradients:&nbsp;[bool](/libs/std/core/type.bool.md), fixed_batch_size:&nbsp;[int](/libs/std/core/type.int.md), seed:&nbsp;[int](/libs/std/core/type.int.md)):&nbsp;[AutoEncoderNetwork](/libs/algebra/nn/type.AutoEncoderNetwork.md)<Badge text="static" />
### fn optimize(engine:&nbsp;[ComputeEngine](/libs/algebra/compute/type.ComputeEngine.md)):&nbsp;any?
### fn setEncoderLayer(layerIndex:&nbsp;[int](/libs/std/core/type.int.md)):&nbsp;any?
