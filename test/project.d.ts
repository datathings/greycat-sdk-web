...
declare namespace gc {
  namespace project {
    ...
    class Whatever extends gc.sdk.GCObject {
      static readonly _type = 'project::Whatever';
      node: gc.core.node<gc.project.Point>;
      constructor(node: gc.core.node<gc.project.Point>);
      static createFrom(fields: {node: gc.core.node<gc.project.Point>}): Whatever;
    }
    ...
    class whatever$args extends gc.sdk.GCObject {
      static readonly _type = 'project::whatever$args';
    }
    ...
    class arr_of_nodes$args extends gc.sdk.GCObject {
      static readonly _type = 'project::arr_of_nodes$args';
      arr: globalThis.Array<gc.core.node<gc.project.Point>>;
      constructor(arr: globalThis.Array<gc.core.node<gc.project.Point>>);
      static createFrom(fields: {arr: globalThis.Array<gc.core.node<gc.project.Point>>}): arr_of_nodes$args;
    }
    ...
    function whatever($g?: gc.sdk.GreyCat, $signal?: globalThis.AbortSignal): Promise<globalThis.Array<gc.project.Whatever>>;
    function arr_of_nodes(arr: globalThis.Array<gc.core.node<gc.project.Point>>, $g?: gc.sdk.GreyCat, $signal?: globalThis.AbortSignal): Promise<unknown>;
  }
  ...
  namespace sdk {
    interface GreyCat {
        ...
        call(method: 'project::whatever', args?: undefined, signal?: globalThis.AbortSignal): Promise<globalThis.Array<gc.project.Whatever>>;
        spawn(method: 'project::whatever', args?: undefined, signal?: globalThis.AbortSignal): Promise<gc.runtime.Task>;
        spawnAwait(method: 'project::whatever', args?: undefined, pollEvery?: number, signal?: globalThis.AbortSignal): Promise<globalThis.Array<gc.project.Whatever>>;
        call(method: 'project::arr_of_nodes', args: [globalThis.Array<gc.core.node<gc.project.Point>>], signal?: globalThis.AbortSignal): Promise<unknown>;
        spawn(method: 'project::arr_of_nodes', args: [globalThis.Array<gc.core.node<gc.project.Point>>], signal?: globalThis.AbortSignal): Promise<gc.runtime.Task>;
        spawnAwait(method: 'project::arr_of_nodes', args: [globalThis.Array<gc.core.node<gc.project.Point>>], pollEvery?: number, signal?: globalThis.AbortSignal): Promise<unknown>;
    }
  }
  interface $TypesMap {
  ...
  interface $FieldsMap {
    ...
    'project::arr_of_nodes$args::arr': 0,
    'project::Foo::a': 0,
  ...
  export import Whatever = gc.project.Whatever;
  ...
  export import whatever = gc.project.whatever;
  export import arr_of_nodes = gc.project.arr_of_nodes;
}
