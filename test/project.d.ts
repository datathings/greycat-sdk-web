...
declare namespace gc {
  namespace project {
    ...
    const get_node: gc.sdk.ExposedFn<[], unknown>;
    const get_node_time: gc.sdk.ExposedFn<[], unknown>;
    const get_node_list: gc.sdk.ExposedFn<[], unknown>;
    const get_node_index: gc.sdk.ExposedFn<[], unknown>;
    const get_node_geo: gc.sdk.ExposedFn<[], unknown>;
