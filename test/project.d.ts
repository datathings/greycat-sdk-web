...
declare namespace gc {
  namespace project {
    class Root extends gc.sdk.GCObject {
      ...
      "project::w_idx": gc.core.node<number | bigint | null>;
    }
    namespace Root {
      interface $Fields {
        "runtime::usages": 0;
    ...
    class echo_array$args extends gc.sdk.GCObject {
      static readonly _type = 'project::echo_array$args';
    ...
    class make_person$args extends gc.sdk.GCObject {
      static readonly _type = 'project::make_person$args';
    ...
    class sum_array$args extends gc.sdk.GCObject {
      static readonly _type = 'project::sum_array$args';
    ...
    class concat$args extends gc.sdk.GCObject {
      static readonly _type = 'project::concat$args';
    ...
    class echo_any$args extends gc.sdk.GCObject {
      static readonly _type = 'project::echo_any$args';
    ...
    class no_result$args extends gc.sdk.GCObject {
      static readonly _type = 'project::no_result$args';
    }

    class Color extends gc.sdk.GCEnum {
      static readonly _type = 'project::Color';
    ...
    const concat: gc.sdk.ExposedFn<[string, string], string>;
    const echo_any: gc.sdk.ExposedFn<[any | null | undefined], any | null>;
    const echo_array: gc.sdk.ExposedFn<[globalThis.Array<number | bigint>], globalThis.Array<number | bigint>>;
    const make_person: gc.sdk.ExposedFn<[string, number | bigint, string | null | undefined], gc.project.Person>;
    const sum_array: gc.sdk.ExposedFn<[globalThis.Array<number | bigint>], number | bigint>;
    const boom: gc.sdk.ExposedFn<[], unknown>;
    const no_result: gc.sdk.ExposedFn<[], unknown>;
  }
  ...
  interface $TypesMap {
    ...
    'runtime::Identity$setPassword$args': 0,
    ...
    'project::boom$args': 0,
    'project::Box': 0,
    'project::echo_array$args': 0,
    'project::add$args': 0,
    'project::make_person$args': 0,
    'project::sum_array$args': 0,
    'project::concat$args': 0,
    'project::echo_any$args': 0,
    'project::no_result$args': 0,
    'project::Color': 0,
    'project::Person': 0,
  }
  ...
  interface $FieldsMap {
    ...
    'runtime::Identity::read_grants': 0,
    'runtime::Identity::write_grants': 0,
    ...
    'runtime::Identity$login$args::credentials': 0,
    ...
    'runtime::Identity$setPassword$args::name': 0,
    'runtime::Identity$setPassword$args::pass': 0,
    'runtime::Log::level': 0,
    'runtime::Log::time': 0,
    ...
    'project::Box::value': 0,
    'project::echo_array$args::a': 0,
    'project::add$args::a': 0,
    'project::add$args::b': 0,
    'project::make_person$args::name': 0,
    'project::make_person$args::age': 0,
    'project::make_person$args::nickname': 0,
    'project::sum_array$args::a': 0,
    'project::concat$args::a': 0,
    'project::concat$args::b': 0,
    'project::echo_any$args::v': 0,
    'project::Person::name': 0,
    'project::Person::age': 0,
    'project::Person::nickname': 0,
  }
  ...
  interface $FunctionsMap {
    ...
    'runtime::Identity::setPassword': 0,
    ...
    'project::concat': 0,
    'project::echo_any': 0,
    'project::echo_array': 0,
    'project::make_person': 0,
    'project::sum_array': 0,
    'project::boom': 0,
    'project::no_result': 0,
  }
  ...
  export import Color = gc.project.Color;
  ...
  export import concat = gc.project.concat;
  export import echo_any = gc.project.echo_any;
  export import echo_array = gc.project.echo_array;
  export import make_person = gc.project.make_person;
  export import sum_array = gc.project.sum_array;
  export import boom = gc.project.boom;
  export import no_result = gc.project.no_result;
}
