...
export namespace project {
  export class TrafficLight extends $sdk.GCEnum {
    ...
    constructor(
      type: $sdk.AbiType,
      offset: number,
      public override key: TrafficLight.Field,
      value: $sdk.Value,
    ) {
  ...
  export class ComplexObject extends $sdk.GCObject {
    ...
    static createFrom(
      ...
      return new ComplexObject(
        $g.abi.libs_by_name.get(projectlib.name)!.mapped[1],
        string,
        int,
        float,
        bool,
  ...
  export class SemiRecursive extends $sdk.GCObject {
    ...
    static createFrom(
      { sub }: { sub: project.SemiRecursive | null },
      $g: $sdk.GreyCat = globalThis.greycat.default,
    ): SemiRecursive {
  ...
  export class SensorKind extends $sdk.GCEnum {
    ...
    constructor(
      type: $sdk.AbiType,
      offset: number,
      public override key: SensorKind.Field,
      value: $sdk.Value,
    ) {
      super(type, offset, key, value);
    }
  ...
  export class Link extends $sdk.GCObject {
    ...
    static createFrom(
      { name, next }: { name: string; next: project.Link | null },
      $g: $sdk.GreyCat = globalThis.greycat.default,
    ): Link {
  ...
  export class Sensor extends $sdk.GCObject {
    ...
    static createFrom(
      { id, kind }: { id: bigint | number; kind: project.SensorKind },
      $g: $sdk.GreyCat = globalThis.greycat.default,
    ): Sensor {
  ...
  export function histogram_table(
    $g: $sdk.GreyCat = globalThis.greycat.default,
    $signal?: AbortSignal,
  ): Promise<$sdk.std.core.Table> {
  ...
  export function task_without_params(
    $g: $sdk.GreyCat = globalThis.greycat.default,
    $signal?: AbortSignal,
  ): Promise<unknown> {
  ...
  export function task_long_running(
    $g: $sdk.GreyCat = globalThis.greycat.default,
    $signal?: AbortSignal,
  ): Promise<unknown> {
  ...
  export function complex_object(
    $g: $sdk.GreyCat = globalThis.greycat.default,
    $signal?: AbortSignal,
  ): Promise<unknown> {
  ...
  export function goodFnForTestingFnCallInput(
    name: string,
    flag: boolean,
    item: $sdk.std.core.DurationUnit,
    optionalFlag: boolean | null,
    $g: $sdk.GreyCat = globalThis.greycat.default,
    $signal?: AbortSignal,
  ): Promise<unknown> {
    return $g.call(
      'project::goodFnForTestingFnCallInput',
      [name, flag, item, optionalFlag],
      $signal,
    );
  }
  export function now(
...
export namespace $anon$ {
  export class Anon0 extends $sdk.GCObject {
    static readonly _type =
      '::<string,int,float,bool,char,geo,null,array,nodeTime,nodeIndex,nodeList,nodeGeo,enum>';
...
declare module '@greycat/web' {
  interface GreyCat {
    ...
    call(
      method: 'project::chart_colored_area',
      args?: undefined,
      signal?: AbortSignal,
    ): Promise<$sdk.std.core.Table>;
    spawn(
    ...
    call(
      method: 'project::histogram_table',
      args?: undefined,
      signal?: AbortSignal,
    ): Promise<$sdk.std.core.Table>;
    spawn(
    ...
    call(
      method: 'project::task_without_params',
      args?: undefined,
      signal?: AbortSignal,
    ): Promise<unknown>;
    spawn(
    ...
    call(
      method: 'project::task_long_running',
      args?: undefined,
      signal?: AbortSignal,
    ): Promise<unknown>;
    spawn(
    ...
    call(
      method: 'project::add',
      args: [bigint | number, bigint | number],
      signal?: AbortSignal,
    ): Promise<bigint | number>;
    spawn(
      method: 'project::add',
    ...
    call(
      method: 'project::goodFnForTestingFnCallInput',
      args: [string, boolean, $sdk.std.core.DurationUnit, boolean | null],
      signal?: AbortSignal,
    ): Promise<unknown>;
    spawn(
      method: 'project::goodFnForTestingFnCallInput',
