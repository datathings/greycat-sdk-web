...
document.body.appendChild(
  <gui-layout breakpoint={920}>
    ...
    <div slot="main">
      ...
      <p>
        <em>Excepteur sint occaecat cupidatat non proident</em>, sunt in culpa qui officia deserunt
      ...
      <p>
        At vero eos et accusamus et <a href="https://example.com">iusto odio dignissimos</a> ducimus
      ...
      <p>
        Etiam rhoncus, justo vel porttitor placerat, nisi nisi efficitur enim, vitae mollis nunc leo
        in lectus.
      </p>
      ...
      <p>
        Pellentesque tincidunt, erat a <strong>venenatis fermentum</strong>, lectus sapien efficitur
        justo, sit amet ullamcorper sapien leo a mi.
      </p>
      ...
      <p>
        Curabitur vel dui eget lorem scelerisque auctor in et lorem. Integer tempor nisi quis lacus
        tempor, nec interdum sapien ultricies.
      </p>

      <p>
        Nam auctor velit sit amet est tincidunt, nec cursus orci pellentesque. Mauris non nisi vitae
        sapien facilisis porttitor sed ac sapien.
      </p>
