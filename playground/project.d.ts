...
declare namespace greycat {
  namespace project {
    ...
    class Root extends greycat.GCObject {
      ...
      "tx::accounts": greycat.core.nodeIndex<string, greycat.tx.Account> | null;
      "tx::incoming": greycat.core.nodeIndex<number | bigint, greycat.core.node<greycat.tx.Tx>> | null;
      "tx::outgoing": greycat.core.nodeIndex<number | bigint, greycat.core.node<greycat.tx.Tx>> | null;
      "tx::categories": greycat.core.nodeList<greycat.core.str> | null;
    }
  ...
  namespace tx {
    class TxRecord extends greycat.GCObject {
      static readonly _type = 'tx::TxRecord';
      account_id: string;
      type: greycat.tx.TxType;
      tx: greycat.tx.Tx;
      constructor(account_id: string, type: greycat.tx.TxType, tx: greycat.tx.Tx);
      static createFrom(fields: {account_id: string, type: greycat.tx.TxType, tx: greycat.tx.Tx}): TxRecord;
    }

    class TxFormData$load$args extends greycat.GCObject {
      static readonly _type = 'tx::TxFormData$load$args';
      data: greycat.tx.TxFormData;
      constructor(data: greycat.tx.TxFormData);
      static createFrom(fields: {data: greycat.tx.TxFormData}): TxFormData$load$args;
    }

    class TxType extends greycat.GCEnum {
      static readonly _type = 'tx::TxType';
      key: TxType.Field;
      constructor(type: greycat.AbiType, offset: number, key: TxType.Field, value?: unknown);
      static Incoming: TxType;
      static Outgoing: TxType;
    }
    namespace TxType  {
      type Field = 'Incoming'|'Outgoing';
    }

    class Tx extends greycat.GCObject {
      static readonly _type = 'tx::Tx';
      category: greycat.core.str;
      id: number | bigint;
      amount: number;
      constructor(category: greycat.core.str, id: number | bigint, amount: number);
      static createFrom(fields: {category: greycat.core.str, id: number | bigint, amount: number}): Tx;
    }

    class TxFormData extends greycat.GCObject {
      static readonly _type = 'tx::TxFormData';
      type: greycat.tx.TxType;
      category: greycat.core.str;
      id: number | bigint;
      constructor(type: greycat.tx.TxType, category: greycat.core.str, id: number | bigint);
      static createFrom(fields: {type: greycat.tx.TxType, category: greycat.core.str, id: number | bigint}): TxFormData;
      static load(data: greycat.tx.TxFormData, $g?: greycat.GreyCat, $signal?: globalThis.AbortSignal): Promise<greycat.tx.Tx | null>;
    }

    class Account extends greycat.GCObject {
      static readonly _type = 'tx::Account';
      id: string;
      incoming: greycat.core.nodeIndex<number | bigint, greycat.core.node<greycat.tx.Tx>> | null;
      outgoing: greycat.core.nodeIndex<number | bigint, greycat.core.node<greycat.tx.Tx>> | null;
      constructor(id: string, incoming?: greycat.core.nodeIndex<number | bigint, greycat.core.node<greycat.tx.Tx>> | null, outgoing?: greycat.core.nodeIndex<number | bigint, greycat.core.node<greycat.tx.Tx>> | null);
      static createFrom(fields: {id: string, incoming?: greycat.core.nodeIndex<number | bigint, greycat.core.node<greycat.tx.Tx>> | null, outgoing?: greycat.core.nodeIndex<number | bigint, greycat.core.node<greycat.tx.Tx>> | null}): Account;
    }
  ...
  namespace any {
    class AnyInput extends greycat.GCObject {
      ...
      type: greycat.core.type;
      field: greycat.core.field;
      never: greycat.core.null_;
      constructor(type: greycat.core.type, field: greycat.core.field, never: greycat.core.null_);
      static createFrom(fields: {type: greycat.core.type, field: greycat.core.field, never: greycat.core.null_}): AnyInput;
    }
...
declare namespace greycat {
  interface GreyCat {
      ...
      call(method: 'tx::TxFormData::load', args: [greycat.tx.TxFormData], signal?: globalThis.AbortSignal): Promise<greycat.tx.Tx | null>;
      spawn(method: 'tx::TxFormData::load', args: [greycat.tx.TxFormData], signal?: globalThis.AbortSignal): Promise<greycat.runtime.Task>;
      spawnAwait(method: 'tx::TxFormData::load', args: [greycat.tx.TxFormData], pollEvery?: number, signal?: globalThis.AbortSignal): Promise<greycat.tx.Tx | null>;
  }
}
