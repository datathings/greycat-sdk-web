...
declare namespace gc {
  namespace project {
    ...
    namespace Root {
      interface $Fields {
        ...
        "project::person": 9;
        "project::huge_table": 10;
        "heatmap::earthquakes_by_geo": 11;
        "heatmap::earthquakes_by_time": 12;
        "cities::cities": 13;
      }
    }
    ...
    const tensor: gc.sdk.ExposedFn<[], gc.core.Tensor>;
    /**
     * `[2, 3, 5] => 2 table * (3 row x 5 col)`
     */
    const tensor_2_3_5: gc.sdk.ExposedFn<[], gc.core.Tensor>;
    const tensor_3_5: gc.sdk.ExposedFn<[], gc.core.Tensor>;
    const generate_logs: gc.sdk.ExposedFn<[], unknown>;
    const getTensor: gc.sdk.ExposedFn<[], gc.core.Tensor>;
  }
  ...
  namespace big {
    ...
    const get_huge_object: gc.sdk.ExposedFn<[], gc.big.BigResult>;
  }
  ...
  interface $FieldsMap {
    ...
    'runtime::RuntimeUsage::process_memory': 0,
