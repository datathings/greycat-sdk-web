...
declare namespace gc {
  ...
  namespace openid {
    class Openid$callback$args extends gc.sdk.GCObject {
      static readonly _type = 'openid::Openid$callback$args';
      static readonly $fields: Openid$callback$args.$Fields;
      code: string;
      state: string;
      constructor(code: string, state: string);
      static createFrom(fields: {code: string, state: string}): Openid$callback$args;
    }
    namespace Openid$callback$args {
      interface $Fields {
        code: 0;
        state: 1;
      }
    ...
    class Openid$providers$args extends gc.sdk.GCObject {
      static readonly _type = 'openid::Openid$providers$args';
    }

    class OpenidHelpers extends gc.sdk.GCObject {
      static readonly _type = 'openid::OpenidHelpers';
    }

    class Openid extends gc.sdk.GCObject {
      static readonly _type = 'openid::Openid';
      /**
       * Build the provider's RP-initiated logout URL. The frontend should:
       *
       * 1. Call `runtime::Identity::logout()` to clear the GC session cookie.
       * 2. `window.location.replace(end_session_url(...))` to log the user out
       *    at the provider.
       *
       * Returns `null` when the provider has no `end_session_endpoint`.
       */
      static end_session_url: ((provider_id: string, id_token_hint: string, post_logout_redirect_uri?: string | null, $g?: gc.sdk.GreyCat, $signal?: globalThis.AbortSignal) => Promise<string | null>) & {
        spawn(provider_id: string, id_token_hint: string, post_logout_redirect_uri?: string | null, $g?: gc.sdk.GreyCat, $signal?: globalThis.AbortSignal): Promise<gc.runtime.Task<string | null>>;
      };
      /**
       * Token-exchange entry for clients that already hold an ID token
       * (mobile, CLI, SPAs using a provider SDK). Verifies the JWT, resolves
       * the Identity, and impersonates that Identity for the current request —
       * the response will carry a `Set-Cookie: greycat=...` header automatically.
       */
      static token_login: ((provider_id: string, jwt: string, $g?: gc.sdk.GreyCat, $signal?: globalThis.AbortSignal) => Promise<unknown>) & {
        spawn(provider_id: string, jwt: string, $g?: gc.sdk.GreyCat, $signal?: globalThis.AbortSignal): Promise<gc.runtime.Task<unknown>>;
      };
      /**
       * Complete the redirect flow. Called by the embedded `index.html` when
       * it sees `?code=&state=` in its own URL (the provider's redirect
       * target), which POSTs them here.
       *
       * Looks up + removes the pending-login entry by `state` (replay-proof),
       * exchanges the code at `token_endpoint` using the PKCE verifier, verifies
       * the ID token signature + `iss` + `aud` + `exp` + `nonce`, resolves to
       * an Identity via the hook (or `OpenidHelpers::default_match`), and
       * impersonates that Identity for the current request — the response will
       * carry a `Set-Cookie: greycat=...` header automatically.
       *
       * Returns the stashed `return_to` (the URL the frontend should redirect
       * the browser back to). Throws on any verification failure.
       */
      static callback: ((code: string, state: string, $g?: gc.sdk.GreyCat, $signal?: globalThis.AbortSignal) => Promise<string>) & {
        spawn(code: string, state: string, $g?: gc.sdk.GreyCat, $signal?: globalThis.AbortSignal): Promise<gc.runtime.Task<string>>;
      };
      /**
       * Begin the redirect flow for `provider_id`.
       *
       * Generates `state`, `nonce`, and a PKCE verifier; stashes them in the
       * native TTL map (along with `return_to`); returns the provider's
       * authorization URL. The frontend should `window.location.replace` to it.
       */
      static login: ((provider_id: string, return_to?: string | null, $g?: gc.sdk.GreyCat, $signal?: globalThis.AbortSignal) => Promise<string>) & {
        spawn(provider_id: string, return_to?: string | null, $g?: gc.sdk.GreyCat, $signal?: globalThis.AbortSignal): Promise<gc.runtime.Task<string>>;
      };
      /**
       * Secret-free config for one provider, so a browser client driving the
       * token-exchange flow can use the server as the single source of truth for
       * `issuer` / `client_id` / `redirect_uri` / `scopes` instead of duplicating
       * them in the frontend. Returns `null` when the provider is not registered.
       */
      static public_config: ((id: string, $g?: gc.sdk.GreyCat, $signal?: globalThis.AbortSignal) => Promise<gc.openid.OidcPublicConfig | null>) & {
        spawn(id: string, $g?: gc.sdk.GreyCat, $signal?: globalThis.AbortSignal): Promise<gc.runtime.Task<gc.openid.OidcPublicConfig | null>>;
      };
      /**
       * List registered provider ids — for login pages that render a button grid.
       */
      static providers: (($g?: gc.sdk.GreyCat, $signal?: globalThis.AbortSignal) => Promise<globalThis.Array<string>>) & {
        spawn($g?: gc.sdk.GreyCat, $signal?: globalThis.AbortSignal): Promise<gc.runtime.Task<globalThis.Array<string>>>;
      };
    }

    class OidcResult extends gc.sdk.GCObject {
      static readonly _type = 'openid::OidcResult';
      static readonly $fields: OidcResult.$Fields;
      claims: gc.openid.OidcClaims;
      id_token: string;
      access_token: string | null;
      refresh_token: string | null;
      constructor(claims: gc.openid.OidcClaims, id_token: string, access_token?: string | null, refresh_token?: string | null);
      static createFrom(fields: {claims: gc.openid.OidcClaims, id_token: string, access_token?: string | null, refresh_token?: string | null}): OidcResult;
    }
    namespace OidcResult {
      interface $Fields {
        claims: 0;
        id_token: 1;
        access_token: 2;
    ...
    class Openid$token_login$args extends gc.sdk.GCObject {
      static readonly _type = 'openid::Openid$token_login$args';
      static readonly $fields: Openid$token_login$args.$Fields;
      provider_id: string;
      jwt: string;
      constructor(provider_id: string, jwt: string);
      static createFrom(fields: {provider_id: string, jwt: string}): Openid$token_login$args;
    }
    namespace Openid$token_login$args {
      interface $Fields {
        provider_id: 0;
        jwt: 1;
      }
    ...
    class OidcPublicConfig extends gc.sdk.GCObject {
      static readonly _type = 'openid::OidcPublicConfig';
      static readonly $fields: OidcPublicConfig.$Fields;
      issuer: string;
      client_id: string;
      redirect_uri: string;
      scopes: globalThis.Array<string> | null;
      constructor(issuer: string, client_id: string, redirect_uri: string, scopes?: globalThis.Array<string> | null);
      static createFrom(fields: {issuer: string, client_id: string, redirect_uri: string, scopes?: globalThis.Array<string> | null}): OidcPublicConfig;
    }
    namespace OidcPublicConfig {
      interface $Fields {
        issuer: 0;
        client_id: 1;
        redirect_uri: 2;
    ...
    class Openid$login$args extends gc.sdk.GCObject {
      static readonly _type = 'openid::Openid$login$args';
      static readonly $fields: Openid$login$args.$Fields;
      provider_id: string;
      return_to: string | null;
      constructor(provider_id: string, return_to?: string | null);
      static createFrom(fields: {provider_id: string, return_to?: string | null}): Openid$login$args;
    }
    namespace Openid$login$args {
      interface $Fields {
        provider_id: 0;
        return_to: 1;
      }
    ...
    class Openid$public_config$args extends gc.sdk.GCObject {
      static readonly _type = 'openid::Openid$public_config$args';
      static readonly $fields: Openid$public_config$args.$Fields;
      id: string;
      constructor(id: string);
      static createFrom(fields: {id: string}): Openid$public_config$args;
    }
    namespace Openid$public_config$args {
      interface $Fields {
        id: 0;
      }
    }

    class Openid$end_session_url$args extends gc.sdk.GCObject {
      static readonly _type = 'openid::Openid$end_session_url$args';
      static readonly $fields: Openid$end_session_url$args.$Fields;
      provider_id: string;
      id_token_hint: string;
      post_logout_redirect_uri: string | null;
      constructor(provider_id: string, id_token_hint: string, post_logout_redirect_uri?: string | null);
      static createFrom(fields: {provider_id: string, id_token_hint: string, post_logout_redirect_uri?: string | null}): Openid$end_session_url$args;
    }
    namespace Openid$end_session_url$args {
      interface $Fields {
        provider_id: 0;
        id_token_hint: 1;
        post_logout_redirect_uri: 2;
      }
    }

    class OidcClaims extends gc.sdk.GCObject {
      static readonly _type = 'openid::OidcClaims';
      static readonly $fields: OidcClaims.$Fields;
      sub: string;
      iss: string;
      aud: string;
      exp: gc.core.time;
      ...
      groups: globalThis.Array<string> | null;
      raw: globalThis.Map<string, any | null>;
      constructor(sub: string, iss: string, aud: string, exp: gc.core.time, iat: gc.core.time, email: string | null, email_verified: boolean | null, name: string | null, preferred_username: string | null, groups: globalThis.Array<string> | null, raw: globalThis.Map<string, any | null>);
      static createFrom(fields: {sub: string, iss: string, aud: string, exp: gc.core.time, iat: gc.core.time, email?: string | null, email_verified?: boolean | null, name?: string | null, preferred_username?: string | null, groups?: globalThis.Array<string> | null, raw: globalThis.Map<string, any | null>}): OidcClaims;
    }
    namespace OidcClaims {
      interface $Fields {
        sub: 0;
        iss: 1;
        aud: 2;
    ...
    class OidcProvider extends gc.sdk.GCObject {
      static readonly _type = 'openid::OidcProvider';
      static readonly $fields: OidcProvider.$Fields;
      issuer: string;
      client_id: string;
      ...
      auto_create_identity: boolean | null;
      constructor(issuer: string, client_id: string, client_secret: string | null, scopes: globalThis.Array<string> | null, redirect_uri: string, audience?: string | null, auto_create_identity?: boolean | null);
      static createFrom(fields: {issuer: string, client_id: string, client_secret?: string | null, scopes?: globalThis.Array<string> | null, redirect_uri: string, audience?: string | null, auto_create_identity?: boolean | null}): OidcProvider;
    }
  ...
  interface $TypesMap {
    ...
    'project::obj1$args': 0,
    'project::KLine': 0,
    'openid::Openid$callback$args': 0,
    'openid::Openid$providers$args': 0,
    'openid::OpenidHelpers': 0,
    'openid::Openid': 0,
    'openid::OidcResult': 0,
    'openid::Openid$token_login$args': 0,
    'openid::OidcPublicConfig': 0,
    'openid::Openid$login$args': 0,
    'openid::Openid$public_config$args': 0,
    'openid::Openid$end_session_url$args': 0,
    'openid::OidcClaims': 0,
    'openid::OidcProvider': 0,
  ...
  interface $FieldsMap {
    ...
    'openid::Openid$callback$args::code': 0,
    'openid::Openid$callback$args::state': 0,
    'openid::OidcResult::claims': 0,
    'openid::OidcResult::id_token': 0,
    'openid::OidcResult::access_token': 0,
    'openid::OidcResult::refresh_token': 0,
    'openid::Openid$token_login$args::provider_id': 0,
    'openid::Openid$token_login$args::jwt': 0,
    'openid::OidcPublicConfig::issuer': 0,
    'openid::OidcPublicConfig::client_id': 0,
    'openid::OidcPublicConfig::redirect_uri': 0,
    'openid::OidcPublicConfig::scopes': 0,
    'openid::Openid$login$args::provider_id': 0,
    'openid::Openid$login$args::return_to': 0,
    'openid::Openid$public_config$args::id': 0,
    'openid::Openid$end_session_url$args::provider_id': 0,
    'openid::Openid$end_session_url$args::id_token_hint': 0,
    'openid::Openid$end_session_url$args::post_logout_redirect_uri': 0,
    'openid::OidcClaims::sub': 0,
    'openid::OidcClaims::iss': 0,
    'openid::OidcClaims::aud': 0,
    'openid::OidcClaims::exp': 0,
    'openid::OidcClaims::iat': 0,
    'openid::OidcClaims::email': 0,
    'openid::OidcClaims::email_verified': 0,
    'openid::OidcClaims::name': 0,
    'openid::OidcClaims::preferred_username': 0,
    'openid::OidcClaims::groups': 0,
    'openid::OidcClaims::raw': 0,
    'openid::OidcProvider::issuer': 0,
    'openid::OidcProvider::client_id': 0,
    'openid::OidcProvider::client_secret': 0,
    'openid::OidcProvider::scopes': 0,
    'openid::OidcProvider::redirect_uri': 0,
    'openid::OidcProvider::audience': 0,
    'openid::OidcProvider::auto_create_identity': 0,
  ...
  interface $FunctionsMap {
    ...
    'openid::Openid::end_session_url': 0,
    'openid::Openid::token_login': 0,
    'openid::Openid::callback': 0,
    'openid::Openid::login': 0,
    'openid::Openid::public_config': 0,
    'openid::Openid::providers': 0,
  ...
  export import OpenidHelpers = gc.openid.OpenidHelpers;
  export import Openid = gc.openid.Openid;
  export import OidcResult = gc.openid.OidcResult;
  export import OidcPublicConfig = gc.openid.OidcPublicConfig;
  export import OidcClaims = gc.openid.OidcClaims;
  export import OidcProvider = gc.openid.OidcProvider;
