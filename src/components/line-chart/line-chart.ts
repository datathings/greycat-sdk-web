...
//   get table(): core.Table | undefined {
//     return this._table;
//   }
...
//         const xValue = table.cols[s.x.colIdx][nearestX];
//         const yValue = table.cols[s.colIdx][nearestX];
...
//     columns,
//     index,
//   }: { table?: core.Table; columns?: number[]; index?: number } = {}) {
...
//   private _updateWidthAndHeight(scales: TableScales, table: core.Table) {
