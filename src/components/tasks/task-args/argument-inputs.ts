...
abstract class BaseInput<TValue, HElement> {
  ...
  protected greycat = window.greycat.default;
...
export class DurationInput extends BaseInput<core.duration, HTMLElement> {
  ...
  protected updateValue() {
    switch (this.unit) {
      case 'microseconds':
        this.value = core.duration.create(this.number, this.greycat);
        break;
      case 'milliseconds':
        this.value = core.duration.from_ms(this.number, this.greycat);
        break;
      case 'seconds':
        this.value = core.duration.from_secs(this.number, this.greycat);
        break;
      case 'minutes':
        this.value = core.duration.from_mins(this.number, this.greycat);
        break;
      case 'hours':
        this.value = core.duration.from_hours(this.number, this.greycat);
        break;
      case 'days':
        this.value = core.duration.from_days(this.number, this.greycat);
        break;
      case 'weeks':
        this.value = core.duration.from_weeks(this.number, this.greycat);
        break;
      case 'months':
        this.value = core.duration.from_months(this.number, this.greycat);
        break;
      case 'years':
        this.value = core.duration.from_years(this.number, this.greycat);
        break;
      default:
        return;
    }
