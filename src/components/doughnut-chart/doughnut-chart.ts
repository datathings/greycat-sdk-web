...
//  */
// export class GuiDoughnutChart extends HTMLElement implements GuiDoughnutProps {
...
//     return this._table &&
//       this._table.data.length > 0 &&
//       this._table.data[0].length > this._dataColumn
//       ? this._table.data.map((row: unknown[]) => {
//           return row[this._dataColumn] as number;
//         })
//       : [];
//   }

//   private _getTableLabels(labelsIdx: number) {
//     return this._table && this._table.data.length > labelsIdx
//       ? this._table.data.map((row: unknown[]) => {
//           return row[labelsIdx];
//         })
//       : [];
//   }
...
// declare global {
//   interface Window {
//     GuiDoughnutChart: typeof GuiDoughnutChart;
//   }

//   interface HTMLElementTagNameMap {
//     'gui-doughnut-chart': GuiDoughnutChart;
//   }

//   namespace JSX {
//     interface IntrinsicElements {
//       // eslint-disable-next-line @typescript-eslint/no-explicit-any
//       'gui-doughnut-chart': any;
//     }
//   }
// }

// if (!window.customElements.get('gui-doughnut-chart')) {
//   window.GuiDoughnutChart = GuiDoughnutChart;
//   window.customElements.define('gui-doughnut-chart', GuiDoughnutChart);
// }
