  ...
  export namespace std_n {
    export namespace core {
      export class geo extends GCObject {
        ...
        static create(value: bigint, g: GreyCat = $.default): greycat.core.geo {
          const ty = g.abi.types[g.abi.core.geo];
          return new ty.ctor(value) as greycat.core.geo;
        }

        static fromLatLng(lat: number, lng: number): greycat.core.geo {
        ...
        static load(r: AbiReader, ty: AbiType): greycat.core.geo {
        ...
        equals(other: greycat.core.geo): boolean {
