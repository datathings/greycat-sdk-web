...
import { interleave64_2d, deinterleave64_2d } from '../../utils/bytes.js';
...
export class geo extends GCPrimitive {
  ...
  static create(value: bigint, g: GreyCat = $.default): gc.core.geo {
  ...
  static fromLatLng(lat: number | { lat: number; lng: number }, lng?: number): gc.core.geo {
    ...
    throw new Error('gc.core.geo.fromLatLng(...) expects either 2 numbers arguments, or 1 latlng object');
  }
