...
export class time extends GCPrimitive {
  ...
  static now(g: GreyCat = $.default): gc.core.time {
    const ty = g.abi.types[g.abi.core.time];
    return new ty.ctor(globalThis.Date.now() * 1000) as gc.core.time;
  }

  static create(value: bigint | number, g: GreyCat = $.default): gc.core.time {
    const ty = g.abi.types[g.abi.core.time];
    return new ty.ctor(value) as gc.core.time;
  }

  static fromDate(date: globalThis.Date, g: GreyCat = $.default): gc.core.time {
    return time.fromMs(date.getTime(), g);
  }

  static fromMs(epochMs: number, g: GreyCat = $.default): gc.core.time {
    const ty = g.abi.types[g.abi.core.time];
  ...
  add(duration: gc.core.duration, g: GreyCat = $.default): gc.core.time {
  ...
  sub(duration: gc.core.duration | gc.core.time, g: GreyCat = $.default): gc.core.time | gc.core.duration {
