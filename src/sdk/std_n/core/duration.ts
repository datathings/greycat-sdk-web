  ...
  export namespace std_n {
    export namespace core {
      export class duration extends GCObject {
        ...
        static create(value: bigint | number, g: GreyCat = $.default): greycat.core.duration {
          const ty = g.abi.types[g.abi.core.duration];
          return new ty.ctor(value) as duration;
        }

        static from_ms(value: number, g: GreyCat = $.default): greycat.core.duration {
          const ty = g.abi.types[g.abi.core.duration];
          return new ty.ctor(value * Number(duration.MILLISECOND)) as greycat.core.duration;
        }

        static from_secs(value: number, g: GreyCat = $.default): greycat.core.duration {
          const ty = g.abi.types[g.abi.core.duration];
          return new ty.ctor(value * Number(duration.SECOND)) as greycat.core.duration;
        }

        static from_mins(value: number, g: GreyCat = $.default): greycat.core.duration {
          const ty = g.abi.types[g.abi.core.duration];
          return new ty.ctor(value * Number(duration.MINUTE)) as greycat.core.duration;
        }

        static from_hours(value: number, g: GreyCat = $.default): greycat.core.duration {
          const ty = g.abi.types[g.abi.core.duration];
          return new ty.ctor(value * Number(duration.HOUR)) as greycat.core.duration;
        }

        static from_days(value: number, g: GreyCat = $.default): greycat.core.duration {
          const ty = g.abi.types[g.abi.core.duration];
          return new ty.ctor(value * Number(duration.DAY)) as greycat.core.duration;
        }

        static from_weeks(value: number, g: GreyCat = $.default): greycat.core.duration {
          const ty = g.abi.types[g.abi.core.duration];
          return new ty.ctor(value * Number(duration.WEEK)) as greycat.core.duration;
        }

        static from_months(value: number, g: GreyCat = $.default): greycat.core.duration {
          const ty = g.abi.types[g.abi.core.duration];
          return new ty.ctor(value * Number(duration.MONTH)) as greycat.core.duration;
        }

        static from_years(value: number, g: GreyCat = $.default): greycat.core.duration {
          const ty = g.abi.types[g.abi.core.duration];
          return new ty.ctor(value * Number(duration.YEAR)) as greycat.core.duration;
        }
        ...
        static from_unit(
          value: number,
          unit: greycat.core.DurationUnit,
          g: GreyCat = $.default,
        ): greycat.core.duration {
          switch (unit.key) {
            case 'microseconds':
        ...
        static load(r: AbiReader, ty: AbiType): greycat.core.duration {
          const value = r.read_vi64();
          return new ty.ctor(value) as greycat.core.duration;
        }
