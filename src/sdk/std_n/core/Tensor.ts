  ...
  export namespace std_n {
    export namespace core {
      ...
      export class Tensor extends GCObject {
        ...
        constructor(
          public shape: number[] = [],
          public type: greycat.core.TensorType = greycat.core.TensorType.i64,
        ...
        static load(r: AbiReader, ty: AbiType): Tensor {
          ...
          if (nb_dim === 0) {
            return new ty.ctor(shape, tensorType, size, null) as greycat.core.Tensor;
          }
          ...
          return new ty.ctor(shape, tensorType, size, data) as greycat.core.Tensor;
        }
