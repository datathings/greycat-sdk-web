...
export class nodeIndex<K = unknown, V = unknown> extends GCPrimitive {
  ...
  static create(value: bigint, g: GreyCat = $.default): gc.core.nodeIndex {
    const ty = g.abi.types[g.abi.core.node_index];
    return new ty.ctor(value) as gc.core.nodeIndex;
  }

  static override load(r: AbiReader, ty: AbiType): gc.core.nodeIndex {
