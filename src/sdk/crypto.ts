  ...
  export namespace sdk {
    ...
    export function sha256hex(data: string, utf8encode: boolean = true): string {
      ...
      c.hash = function (a: string, f: boolean): string {
        ...
        const b = [1779033703, 3144134277, 1013904242, 2773480762, 1359893119, 2600822924, 528734635, 1541459225];
        ...
        return c.b(b[0]) + c.b(b[1]) + c.b(b[2]) + c.b(b[3]) + c.b(b[4]) + c.b(b[5]) + c.b(b[6]) + c.b(b[7]);
      };
