namespace gc {
  export namespace sdk {
    ...
    export class BinaryWriter extends gc.sdk.AbiWriter {
      constructor(abi: gc.sdk.Abi = gc.$.default.abi, capacityOrBuffer?: number | ArrayBuffer) {
    ...
    export class BinaryReader extends gc.sdk.AbiReader {
      ...
      static fromHex<T = unknown>(hex: string, abi = gc.$.default.abi): T {
